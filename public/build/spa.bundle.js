...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _localStorege = __webpack_require__(77);

	var _localStorege2 = _interopRequireDefault(_localStorege);

	var _appConfig = __webpack_require__(78);
...
/***/ (function(module, exports) {
	...
	exports.default = {
	    ...
	    setObject: function setObject(key, valeu) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jwtToken = __webpack_require__(83);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _resources = __webpack_require__(84);
	...
	exports.default = {
	    get token() {
	        return _localStorege2.default.get(TOKEN);
	    },
	    set token(value) {
	        return value ? _localStorege2.default.set(TOKEN, value) : _localStorege2.default.remove(TOKEN);
	    },
	    ...
	    revokeToken: function revokeToken() {
	        ...
	        var afterRevokeToken = function afterRevokeToken(response) {
	            _this3.token = null;
	            return response;
	        };
	    ...
	    getAuthorizationHeader: function getAuthorizationHeader() {
	        return 'Bearer ' + _localStorege2.default.get(TOKEN);
	    }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    user: {
	        set data(value) {
	            if (!value) {
	                _localStorege2.default.remove(USER);
	                this._data = null;
	                return;
	            }
	            this._data = value;
	            _localStorege2.default.setObject(_resources.User, value);
	        },
	        get data() {
	            if (!this._data) {
	                this._data = _localStorege2.default.getObject(_resources.User);
	            }
	            return this._data;
	        },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: function data() {
	        return {
	            menus: [{ name: 'Contas bancária', routeName: 'bank-account.list' }],
	            menusDropdown: [],
	            user: _auth2.default.user
	        };
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BankAccountList = __webpack_require__(105);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-74a80e9a/Dashboard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-bdbf4b74/BankAccountList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
